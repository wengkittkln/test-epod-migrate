...
import {usePodAction} from '../../../../Hooks/JobList/Action/POD/usePodAction';
...
export default ({route, navigation}) => {
  ...
  return (
    <View
      ...
      />
      <ScrollView style={styles.podContent}>
      ...
      <View
        ...
        <TouchableHighlight
          ...
          <View>
            <Image style={styles.podIcon} source={FailedIcon} />
            <Text style={styles.podFailButtonText}>
        ...
        <TouchableHighlight
          ...
          <View style={styles.button}>
            <Image style={styles.podIcon} source={CompleteIcon} />
            <Text style={styles.podCompleteButtonText}>
