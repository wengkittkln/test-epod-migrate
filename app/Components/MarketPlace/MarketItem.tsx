...
type MarketPlaceItemProps = {
  ...
  onDeselected: (job: Job) => void;
  data: Job;
};

export const MarketPlaceItem: FC<MarketPlaceItemProps> = (props) => {
  const {onSelected, onDeselected, data} = props;
      ...
      {data.isSelected && (
        <View style={styles.selectedContainer}>
          <Pressable
            ...
            <Text style={styles.cancelBtn}>{translationString.cancel_btn}</Text>
          </Pressable>
        </View>
      )}
      <TouchableOpacity
        ...
        disabled={data.status > Constants.JobStatus.FAILED ? true : false}
